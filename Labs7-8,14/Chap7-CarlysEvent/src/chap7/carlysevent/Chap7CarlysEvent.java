 ...
 * Author: Brian Moye
 * Date: 2020/12/01
 * Program: Chap7-CarlysEvent
 * Purpose: Modifies Carlys Event so that the program asks for a phone number.
 */
...
public class Chap7CarlysEvent {
    ...
    public static void displayEventInfo(Event event) {
        ...
        JOptionPane.showMessageDialog(null, 
            "The contact phone number given is: " + event.getPhoneNumber()
            + "\nThe cost for Event #" + event.getEventNum() + " with "
